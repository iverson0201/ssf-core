...
//            t = loadTemplate(loader, name, locale, encoding, parse, source);
    ...
    /**
     * If IcI >= 2.3.21, sets {@link cn.ocoop.ssf.freemarker.cache.URLTemplateSource#setUseCaches(boolean)} to {@code false} for sources that come
    ...
    private Object modifyForConfIcI(Object templateSource) {
        ...
        if (templateSource instanceof cn.ocoop.ssf.freemarker.cache.URLTemplateSource) {
            cn.ocoop.ssf.freemarker.cache.URLTemplateSource urlTemplateSource = (cn.ocoop.ssf.freemarker.cache.URLTemplateSource) templateSource;
