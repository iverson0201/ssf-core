package cn.ocoop.ssf.freemarker.config;
...
public class Configuration extends freemarker.template.Configuration {
    ...
    private cn.ocoop.ssf.freemarker.cache.TemplateCache cache;
    ...
    private void createTemplateCache() {
        cache = new cn.ocoop.ssf.freemarker.cache.TemplateCache(getDefaultTemplateLoader(), this);
        cache.clear(); // for fully BC behavior
        cache.setDelay(5000);
    }

    private void recreateTemplateCacheWith(TemplateLoader loader, CacheStorage storage) {
        cn.ocoop.ssf.freemarker.cache.TemplateCache oldCache = cache;
        cache = new cn.ocoop.ssf.freemarker.cache.TemplateCache(loader, storage, this);
        cache.clear(); // for fully BC behavior
